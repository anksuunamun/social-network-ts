...
export const setDisabledButtonAC = (
  id: number,
  isFetching: boolean,
...
export const SetSearchFilterAC = (
  term: string,
  friend: boolean | null,
...
export const getUsersThunkAC = (
  ...
  return (dispatch: ThunkDispatch<AppStateType, unknown, ActionType>) => {
    ...
    usersAPI
      .getUsers(portionSize, currentPage, term, friend)
      .then((response) => {
...
export const onPageClickThunkAC = (
  portionSize: number,
  currentPage: number,
  term = '',
  friend: boolean | null = null,
...
export const usersReducer = (
  state: UsersReducerInitialStateType = initialState,
  action: ActionType,
