...
const ProfileContactsEditForm: React.FC<InjectedFormProps<FormDataType, ProfileContactsEditFormPropsType> & ProfileContactsEditFormPropsType> = (props) => {
    ...
    return (
        <div>
            <form onSubmit={props.handleSubmit}>
                ...
                {createField(Input, 'lookingForAJob', 'checkbox', [], 'Looking for a job', 'lookingForAJob', 'Looking for a job')}
                {createField(Input, 'lookingForAJobDescription', 'text', [], 'Looking for a job description', 'lookingForAJobDescription', 'Looking for a job description')}
                {contacts}
            </form>
        </div>
    )
...
export default reduxForm<FormDataType, ProfileContactsEditFormPropsType>({form: 'profileEditForm'})(ProfileContactsEditForm);